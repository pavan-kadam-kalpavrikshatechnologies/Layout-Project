		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sapktdemolayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapktdemolayout-display": {
								"semanticObject": "sapktdemolayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.kt.demo.layout",
									"url": sap.ui.require.toUrl("sap/kt/demo/layout")
								}
							}
						}
					}
